...
namespace Elevador_Simulador
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            // Temporizador responsável pela animação das portas do elevador
        ...
        /// <summary>
        /// Solicitar desenbarque no andar térreo
        /// </summary>
        ...
        /// <summary>
        /// Solicitar desenbarque no andar indicado no botão 1
        /// </summary>
        ...
        /// <summary>
        /// Solicitar desenbarque no andar indicado no botão 2
        /// </summary>
        ...
        /// <summary>
        /// Solicitar desenbarque no andar indicado no botão 3
        /// </summary>
        ...
        /// <summary>
        /// Solicitar desenbarque no andar indicado no botão 4 
        /// </summary>
        ...
        /// <summary>
        /// Solicitar desenbarque no andar indicado no botão 5 
        /// </summary>
        ...
        /// <summary>
        /// Solicitar desenbarque no andar indicado no botão 6 
        /// </summary>
        ...
        /// <summary>
        /// Dispara o alarme de emergência
        /// </summary>
        ...
        /// <summary>
        /// Obtem a sequência de sinais que representam o digito informado por parâmetro
        /// </summary>
        ...
        /// <summary>
        /// Método responsável pela animação das portas do elevador
        /// </summary>
        private void MoverPortas(object source, EventArgs e)
        {
            // Verificar se há permissão para mover as portas
            if (!this.moverPortas && encoderPotas == 0) 
                return;

            // Delay antes de abrir
            if (encoderPotas < 30)
            {
                this.encoderPotas++;
            }
            ...
            // Avisar que as portas foram fechadas
        ...
        private void CheckFlags(object source, EventArgs e)
        {
            ...
            this.listLogs.Text = listLogsText;
        }
